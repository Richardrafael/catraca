...
$cons_tabela_terceiro = "SELECT ter.CD_TERCEIRO,
                                ter.CRACHA,
                                ter.DS_RFID,
                                ter.NM_TERCEIRO,
                                ...
                                ter.CD_USUARIO_CADASTRO,
                                ter.HR_CADASTRO,
                                ter.CD_USUARIO_ULT_ALT,
                                ter.HR_ULT_ALT
                                FROM port_catraca.TERCEIROS ter
                                ORDER BY 3 ASC";
$res_cons_tabela_terceiro = oci_parse($conn_ora, $cons_tabela_terceiro);
                            oci_execute($res_cons_tabela_terceiro);
?>
...
<table class="table table-striped" style="text-align: center;">
    ...
    <tbody>
        <?php
        while($row_terceiros = oci_fetch_array($res_cons_tabela_terceiro)){
            ...
            echo '<tr style="text-align: center;">';
                ...
                <td class="align-middle" style="text-align: center;"><button onclick="abre_canguru();ajax_editar_terceiro('<?php echo $row_terceiros['CD_TERCEIRO'];?>');" class="btn btn-adm" style="background-color: #3185c1 !important; border-color: #3185c1 !important;"><i class="fa-solid fa-pen-to-square"></i></button></td>    
